...
- Создайте проект React с помощью create-vite: `npm init --yes vite@latest clubtabletracker.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Создание файла проекта (`clubtabletracker.client.esproj`).
